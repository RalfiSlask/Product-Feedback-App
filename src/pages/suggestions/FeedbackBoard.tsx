...
const FeedbackBoard = () => {
  ...
  return (
    <div className={`${modals.sidebar ? "fixed z-50" : "static"} flex md:flex-col items-center md:items-start justify-between md:justify-end w-full h-[72px] md:h-[178px] xl:h-[133px] md:w-[223px] xl:w-[255px] md:rounded-[10px] px-6 py-4 md:py-6`} style={{backgroundImage: `url(${image})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover"}}>
