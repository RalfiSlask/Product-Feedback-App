...
const FeedbackBoard = () => {
  ...
  return (
    <div
      className={`${
        modals.sidebar ? 'fixed z-50' : 'static'
      } flex md:flex-col items-center md:items-start justify-between md:justify-end w-full h-[72px] md:h-[178px] xl:h-[133px] md:w-[223px] xl:w-[255px] md:rounded-[10px] px-6 py-4 md:py-6`}
      style={{
    ...
    >
      <div className='flex flex-col leading-normal text-white'>
        <h2 className='tracking-[-0.187px] md:tracking-[-0.25px] font-bold text-[0.9375rem] md:text-[1.25rem]'>
          Frontend Mentor
        </h2>
