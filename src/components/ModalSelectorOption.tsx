...
const ModalSelectorOption: React.FC<PropsType> = ( {option, onClick} ) => {
  ...
  return (
    <div onClick={() => {onClick(text)}} className='flex justify-between h-full items-center text-base border border-[#3A4374] border-opacity-10 px-6 text-[#647196] hover:text-[#AD1FEA] cursor-pointer'>
         <div>{text}</div>
