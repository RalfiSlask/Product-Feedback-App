...
const CommentNumberContainer: React.FC<{
  ...
  return (
    <div
      className={`flex gap-2 items-center ${
        suggestion ? '-translate-y-1/2 md:absolute right-8 top-1/2' : ''
      }`}
    >
      <div>
      ...
      <p
        className={`${
          comments === undefined ? 'opacity-50' : ''
        } text-[#3A4374] font-bold tracking-[-0.181px] md:text-[1rem]`}
      >
