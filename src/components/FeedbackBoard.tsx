...
const FeedbackBoard = () => {
  ...
  return (
    <div className="flex md:flex-col items-center md:items-start justify-between md:justify-end w-full h-[4.5rem] md:h-[11.125rem] md:w-[13.938rem] md:rounded-[10px] px-6 py-4 md:py-6" style={{backgroundImage: `url(${image})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover"}}>
